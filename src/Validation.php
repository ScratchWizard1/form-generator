...
class Validation
{
        ...
        try {
            ...
            if (in_array(Globals::VALIDATION_CONFIG, $validationKeys)) {
                ...
                if ($result->isValid()) {
                    ...
                    /**
                     * @var array{error: string, code: int, id:string, ...} $error
                     */
            ...
            if (!$recResult['success']) {
                /**
                 * @var array{error: string, code: int, id:string, ...} $err
                 */
                $err = $recResult['error'];
                if ($throw) {
                    throw FormErrorHandler::exception(
            ...
            if (is_array($value) && !$file) {
                ...
                foreach ($value as $subKey => $subValue) {
                    if (is_array($subValue)) {
                        ...
                        if (!$subRec['success']) {
                            return ['success' => false, 'error' => $subRec['error']];
                        }
    ...
    private static function applyTestsToScalar(
        ...
        foreach ($rowTests as $test) {
            ...
            $result = self::$testname($value, $rootKey, $test, $devMessage, $backtrace);
    ...
    protected static function isValidAlpha(
        ...
        $result = Alpha::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
    ...
    protected static function isValidAlphaNumber(
        ...
        $result = AlphaNumber::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidBoolean(
        ...
        $result = Boolean::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidColor(
        ...
        $result = Color::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidDate(
        ...
        $result = Date::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidDateTime(
        ...
        $result = DateTimeRule::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidEmail(
        ...
        $result = Email::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidEnum(
        ...
        $result = Enum::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidNenum(
        ...
        $result = Nenum::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidEqual(
        ...
        $result = Equal::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidNequal(
        ...
        $result = Nequal::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidExtension(
        ...
        $result = Extension::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidMime(
        ...
        $result = Mime::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidSize(
        ...
        $result = Size::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidFile(
        ...
        $result = File::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidIp(
        ...
        $result = Ip::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidJson(
        ...
        $result = Json::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidLength(
        ...
        $result = Length::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidMax(
        ...
        $result = Max::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidMin(
        ...
        $result = Min::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidMaxLength(
        ...
        $result = MaxLength::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidMinLength(
        ...
        $result = MinLength::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidMaxWords(
        ...
        $result = MaxWords::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidMinWords(
        ...
        $result = MinWords::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidMonth(
        ...
        $result = Month::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidNumber(
        ...
        $result = Number::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidPassword(
        ...
        $result = Password::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidRegex(
        ...
        $result = Regex::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidRequired(
        ...
        $backtrace[0] = $backtrace[0] - 1;
        $backtrace[1] = $backtrace[1] - 1;
        $result = Required::check($data, $test, $devMessage, $backtrace);
        if ($result === true) {
            return new ValidationResult(['value' => $data]);
        } else {
            return new ValidationResult(FormErrorHandler::fatalError(
    ...
    protected static function isValidStringRule(
        ...
        $result = StringRule::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } else {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidTel(
        ...
        $result = Tel::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } else {
            return new ValidationResult(FormErrorHandler::fatalError(
    ...
    protected static function isValidTime(
        ...
        $result = Time::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidUrl(
        ...
        $result = Url::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
    ...
    protected static function isValidWeek(
        ...
        $result = Week::check($data, $test, $devMessage, $backtrace);
        if (is_string($result)) {
            return new ValidationResult(['value' => $result]);
        } elseif ($result === true) {
            return new ValidationResult(['value' => $data]);
