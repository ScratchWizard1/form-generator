...
class Nequal extends Validation implements ValidationInterface
{
    /**
    ...
    /**
     * Validate that the provided string is not equal to the specified value.
     *
     * @param string $data
