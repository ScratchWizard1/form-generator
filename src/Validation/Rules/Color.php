...
class Color extends Validation implements ValidationInterface
{
    /**
    ...
    /**
     * Check if the given data is a valid hex color code.
     *
     * @param string $data
        ...
        if (preg_match('/^#[0-9a-fA-F]{6}$/', $data)) {
            ...
            return FormErrorHandler::exceptionOrFalse(
                "Validation error: The value '"
                    . Globals::esc($data)
                    . "' must be a valid hex color code like #RRGGBB.",
                422,
                "vE014",
                $devMessage
            );
